...
<nav class="navbar navbar-expand-lg navbar-dark navbar">
  <div class="container">
    <a class="navbar-brand" href="#"><strong>OnTelaria</strong></a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li><a class="nav-link" href="#">Registrar</a></li>
        <li><a class="nav-link active" style="background-color: #ff751f; border-radius: 5px; color:black; text-align:center;" href="#"><span class="bi bi-person-circle"></span><strong> Login</strong></a></li>
      </ul>
    </div>
  </div>
</nav>