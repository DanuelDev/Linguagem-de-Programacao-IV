...
<html lang="pt-BR">
  <head>
    ...
    <body>
<!-- Crie um formulário que permita ao usuário inserir dois números. O script PHP deve multiplicar esses números e exibir o resultado.-->
    <form method="post">
